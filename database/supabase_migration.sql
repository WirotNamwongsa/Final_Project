...
-- LoeiTech Admission System - Migrate to Supabase
-- ============================================================
...
CREATE TABLE IF NOT EXISTS public.admission_plan (
...
CREATE TABLE IF NOT EXISTS public.applicant_expenses (
...
DROP TRIGGER IF EXISTS set_updated_at ON public.applicants;
...
-- Add payment_type column constraint to expense_detail
...
CHECK (payment_type IN ('mandatory', 'optional', 'custom'));

-- Add comment for prev_branch
